> 대학생 이력서 샘플입니다. 아직 일 한 경력이 없기 때문에 가장 신경써서 만들어야 하는것이 Skill 부분입니다. 지금 어떤 기술을 가지고 있는지 적는것도 중요하지만 앞으로 공부할 기술들을 나열해 두는것도 중요합니다. 우선 지원하고자 하는 채용 공고를 찾아서 그 채용 공고에 적힌 요구사항들을 중심으로 정리해 두세요.
